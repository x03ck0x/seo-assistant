...
export default async function (req, res) {
    const { keywords, name, services, address, language } = req.body;
    const prompt = generatePrompt(keywords, name, services, address, language);
...
function generatePrompt(keywords, name, services, address, language) {
